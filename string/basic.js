...
let str2 = new String('문자열'); //obj type
...
const cal2 = new String('1+2*3'); //obj

// eval(): 문자열 -> 수식 변경
console.log(eval(cal1)); // = ...7 **
console.log(eval(cal2)); // obj **
console.log(eval(cal2.valueOf())); // obj->1+2*3 = ..7
...
// 문자열 공백 제거
result = ' 문자열 공백 테스트 '.split(' '); // 매개값을 기준으로 문장을 잘라 배열.
...
console.log(result);
// 자바스크립트 boolean 값: null, not nulll, 0, '', undefined -> false;
if('문자열'){ // null-> false
  console.log('false값')
}
// substring
// slice, substring, substr(deprecated)
console.log('안녕하세요 반갑습니다.'.slice(0,5)); // 인덱스값 기준 0 ~5잘라내기
console.log('안녕하세요 반갑습니다.'.substring(0,6));
console.log('안녕하세요 반갑습니다.'.slice(0,-6));
